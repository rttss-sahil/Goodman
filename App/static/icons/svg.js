...
const svg = {
    HomeSvg: ({ stroke, fill, size }) =>
        <Svg stroke={stroke || ""} fill={fill} height={`${size || 24}px`} width={`${size || 24}px`} stroke-width="1" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
            <Path d="M10.707 2.293a1 1 0 00-1.414 0l-7 7a1 1 0 001.414 1.414L4 10.414V17a1 1 0 001 1h2a1 1 0 001-1v-2a1 1 0 011-1h2a1 1 0 011 1v2a1 1 0 001 1h2a1 1 0 001-1v-6.586l.293.293a1 1 0 001.414-1.414l-7-7z" />
        </Svg>,
    ProfileSvg: ({ stroke, fill, size }) =>
        <Svg stroke={stroke || ""} fill={fill} height={`${size || 22}px`} width={`${size || 20}px`} stroke-width="1" viewBox="0 0 448 512" xmlns="http://www.w3.org/2000/svg">
    ...
    UploadSvg: ({ stroke, fill, size }) =>
        <Svg stroke={stroke || ""} fill={fill} height={`${size || 24}px`} width={`${size || 24}px`} stroke-width="0" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg">
            <Path fill-rule="evenodd" d="M16 8A8 8 0 110 8a8 8 0 0116 0zM8.5 4a.5.5 0 00-1 0v3.5H4a.5.5 0 000 1h3.5V12a.5.5 0 001 0V8.5H12a.5.5 0 000-1H8.5V4z" clip-rule="evenodd"></Path>
        </Svg>
}
